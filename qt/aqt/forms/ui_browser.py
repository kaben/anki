# Form implementation generated from reading ui file '/mnt/Work/Repos/kaben/ankimath/qt/aqt/forms/browser.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.menuqt_accel_reviews = QtWidgets.QMenu(self.menubar)
        self.menuqt_accel_reviews.setObjectName("menuqt_accel_reviews")
        ...
        self.action_show_notes = QtGui.QAction(Dialog)
        self.action_show_notes.setObjectName("action_show_notes")
        self.action_show_cards = QtGui.QAction(Dialog)
        self.action_show_cards.setObjectName("action_show_cards")
        self.action_show_reviews = QtGui.QAction(Dialog)
        self.action_show_reviews.setObjectName("action_show_reviews")
        self.action_accel_replay = QtGui.QAction(Dialog)
        self.action_accel_replay.setShortcut("Ctrl+Shift+H")
        self.action_accel_replay.setObjectName("action_accel_replay")
        ...
        self.menu_Cards.addAction(self.action_accel_replay)
        ...
        self.menuqt_accel_view.addAction(self.action_show_notes)
        self.menuqt_accel_view.addAction(self.action_show_cards)
        self.menuqt_accel_view.addAction(self.action_show_reviews)
        ...
        self.menubar.addAction(self.menuqt_accel_reviews.menuAction())
    ...
    def retranslateUi(self, Dialog):
        ...
        self.menuEdit.setTitle(_translate("Dialog", "qt_accel_edit"))
        self.menuJump.setTitle(_translate("Dialog", "qt_accel_go"))
        self.menu_Help.setTitle(_translate("Dialog", "qt_accel_help"))
        self.menu_Cards.setTitle(_translate("Dialog", "qt_accel_cards"))
        self.menuFlag.setTitle(_translate("Dialog", "browsing_flag"))
        self.menu_Notes.setTitle(_translate("Dialog", "qt_accel_notes"))
        self.menuqt_accel_view.setTitle(_translate("Dialog", "qt_accel_view"))
        self.menuLayout.setTitle(_translate("Dialog", "qt_accel_layout"))
        self.menuqt_accel_reviews.setTitle(_translate("Dialog", "qt_accel_reviews"))
        self.actionSelectAll.setText(_translate("Dialog", "qt_accel_select_all"))
        self.actionUndo.setText(_translate("Dialog", "qt_accel_undo"))
        self.actionInvertSelection.setText(_translate("Dialog", "qt_accel_invert_selection"))
        self.actionFind.setText(_translate("Dialog", "qt_accel_find"))
        self.actionNote.setText(_translate("Dialog", "qt_accel_note"))
        self.actionNextCard.setText(_translate("Dialog", "qt_accel_next_card"))
        self.actionPreviousCard.setText(_translate("Dialog", "qt_accel_previous_card"))
        self.actionGuide.setText(_translate("Dialog", "qt_accel_guide"))
        self.actionChangeModel.setText(_translate("Dialog", "browsing_change_note_type2"))
        self.actionSelectNotes.setText(_translate("Dialog", "qt_accel_select_notes"))
        self.actionFindReplace.setText(_translate("Dialog", "qt_accel_find_and_replace"))
        self.actionSidebarFilter.setText(_translate("Dialog", "qt_accel_filter"))
        self.actionCardList.setText(_translate("Dialog", "browsing_card_list"))
        self.actionFindDuplicates.setText(_translate("Dialog", "qt_accel_find_duplicates"))
        self.actionReposition.setText(_translate("Dialog", "browsing_reposition"))
        self.actionFirstCard.setText(_translate("Dialog", "browsing_first_card"))
        self.actionLastCard.setText(_translate("Dialog", "browsing_last_card"))
        self.actionClose.setText(_translate("Dialog", "actions_close"))
        self.action_Info.setText(_translate("Dialog", "qt_accel_info"))
        self.actionAdd_Tags.setText(_translate("Dialog", "browsing_add_tags2"))
        self.actionRemove_Tags.setText(_translate("Dialog", "browsing_remove_tags"))
        self.actionToggle_Suspend.setText(_translate("Dialog", "browsing_toggle_suspend"))
        self.actionDelete.setText(_translate("Dialog", "actions_delete"))
        self.actionAdd.setText(_translate("Dialog", "browsing_add_notes"))
        self.actionChange_Deck.setText(_translate("Dialog", "browsing_change_deck2"))
        self.actionRed_Flag.setText(_translate("Dialog", "actions_flag_red"))
        self.actionOrange_Flag.setText(_translate("Dialog", "actions_flag_orange"))
        self.actionGreen_Flag.setText(_translate("Dialog", "actions_flag_green"))
        self.actionBlue_Flag.setText(_translate("Dialog", "actions_flag_blue"))
        self.actionSidebar.setText(_translate("Dialog", "browsing_sidebar"))
        self.actionClear_Unused_Tags.setText(_translate("Dialog", "browsing_clear_unused_tags"))
        self.actionManage_Note_Types.setText(_translate("Dialog", "browsing_manage_note_types"))
        self.actionToggle_Mark.setText(_translate("Dialog", "browsing_toggle_mark"))
        self.actionExport.setText(_translate("Dialog", "qt_accel_export_notes"))
        self.actionCreateFilteredDeck.setText(_translate("Dialog", "qt_misc_create_filtered_deck"))
        self.action_set_due_date.setText(_translate("Dialog", "qt_accel_set_due_date"))
        self.action_forget.setText(_translate("Dialog", "qt_accel_forget"))
        self.actionRedo.setText(_translate("Dialog", "qt_accel_redo"))
        self.actionPink_Flag.setText(_translate("Dialog", "actions_flag_pink"))
        self.actionTurquoise_Flag.setText(_translate("Dialog", "actions_flag_turquoise"))
        self.actionPurple_Flag.setText(_translate("Dialog", "actions_flag_purple"))
        self.actionCopy.setText(_translate("Dialog", "actions_create_copy"))
        self.actionFullScreen.setText(_translate("Dialog", "qt_accel_full_screen"))
        self.actionZoomIn.setText(_translate("Dialog", "qt_accel_zoom_editor_in"))
        self.actionZoomOut.setText(_translate("Dialog", "qt_accel_zoom_editor_out"))
        self.actionResetZoom.setText(_translate("Dialog", "qt_accel_reset_zoom"))
        self.actionLayoutAuto.setText(_translate("Dialog", "qt_accel_layout_auto"))
        self.actionLayoutVertical.setText(_translate("Dialog", "qt_accel_layout_vertical"))
        self.actionLayoutHorizontal.setText(_translate("Dialog", "qt_accel_layout_horizontal"))
        self.action_show_notes.setText(_translate("Dialog", "browsing_show_notes"))
        self.action_show_cards.setText(_translate("Dialog", "browsing_show_cards"))
        self.action_show_cards.setToolTip(_translate("Dialog", "browsing_show_cards"))
        self.action_show_reviews.setText(_translate("Dialog", "browsing_show_reviews"))
        self.action_accel_replay.setText(_translate("Dialog", "qt_accel_replay"))
        self.action_toggle_bury.setText(_translate("Dialog", "browsing_toggle_bury"))
